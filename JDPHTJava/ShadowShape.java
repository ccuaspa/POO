...
abstract class ShadowShape {
  ...
  // private static float sxp;
  // private static float syp;
  ...
  // public ShadowShape(PApplet parent) {
  ...
  public ShadowShape(PApplet parent, float x, float y, float r, float sx, float sy) {
    _parent = parent;
